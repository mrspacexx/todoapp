...
export function Chatbot({ todos }: ChatbotProps) {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: 'assistant',
      content: 'Merhaba! Todo\'larınızla ilgili size nasıl yardımcı olabilirim? Bugün ne yapmalısınız, hangi todo\'larınız var gibi sorular sorabilirsiniz! 😊'
    }
  ])
          ...
          <div className="bg-white rounded-t-xl shadow-2xl w-full max-w-md h-96 flex flex-col">
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-200">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="font-semibold text-gray-900">Todo Asistanı</h3>
              </div>
              <button
